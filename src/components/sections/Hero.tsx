  ...
  return (
    <section id="hero" className="relative h-screen flex flex-col justify-center items-center overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 text-center max-w-4xl px-6 w-full mt-20">
        <Reveal>
          <h2 className="text-secondary font-mono tracking-widest text-[10px] sm:text-xs md:text-sm uppercase mb-6 md:mb-8">
            AI & Generative AI Solutions | Business Development | Enterprise Discovery
          </h2>
        </Reveal>

        <Reveal delay={0.2}>
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-6 md:mb-8 text-white leading-tight">
            Sunshine Shreyas
          </h1>
        </Reveal>

        <Reveal delay={0.4}>
          <p className="text-base md:text-2xl text-gray-300 mb-6 max-w-2xl mx-auto leading-relaxed font-light">
